...
namespace Com.Algorithmia.Data {
	...
	public abstract partial class AbstractDataIterator : global::Java.Lang.Object, global::Java.Util.IIterator {
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.algorithmia.data']/class[@name='AbstractDataIterator']/field[@name='dir']"
		[Register ("dir")]
		protected global::Com.Algorithmia.Data.DataDirectory Dir {
			get {
				if (dir_jfieldId == IntPtr.Zero)
					dir_jfieldId = JNIEnv.GetFieldID (class_ref, "dir", "Lcom/algorithmia/data/DataDirectory;");
				IntPtr __ret = JNIEnv.GetObjectField (((global::Java.Lang.Object) this).Handle, dir_jfieldId);
				return global::Java.Lang.Object.GetObject<global::Com.Algorithmia.Data.DataDirectory> (__ret, JniHandleOwnership.TransferLocalRef);
			}
			set {
				if (dir_jfieldId == IntPtr.Zero)
					dir_jfieldId = JNIEnv.GetFieldID (class_ref, "dir", "Lcom/algorithmia/data/DataDirectory;");
				...
				try {
					JNIEnv.SetField (((global::Java.Lang.Object) this).Handle, dir_jfieldId, native_value);
				} finally {
		...
		static IntPtr id_ctor_Lcom_algorithmia_data_DataDirectory_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.algorithmia.data']/class[@name='AbstractDataIterator']/constructor[@name='AbstractDataIterator' and count(parameter)=1 and parameter[1][@type='com.algorithmia.data.DataDirectory']]"
		[Register (".ctor", "(Lcom/algorithmia/data/DataDirectory;)V", "")]
		protected unsafe AbstractDataIterator (global::Com.Algorithmia.Data.DataDirectory p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (AbstractDataIterator)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Lcom/algorithmia/data/DataDirectory;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(Lcom/algorithmia/data/DataDirectory;)V", __args);
					return;
				}

				if (id_ctor_Lcom_algorithmia_data_DataDirectory_ == IntPtr.Zero)
					id_ctor_Lcom_algorithmia_data_DataDirectory_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Lcom/algorithmia/data/DataDirectory;)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Lcom_algorithmia_data_DataDirectory_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_Lcom_algorithmia_data_DataDirectory_, __args);
			} finally {
			}
		}
